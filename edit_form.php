...
class enrol_attributes_edit_form extends moodleform {
    ...
    protected function add_action_buttons($cancel = true, $submitlabel=null) {
        ...
        if ($cancel) {
            ...
            $buttonarray[] = &$mform->createElement('button', 'purge', get_string('purge', 'enrol_attributes'),
                array('onclick' => 'enrol_attributes_purge(\''.  addslashes(get_string('confirmpurge', 'enrol_attributes')).'\');'));
            $buttonarray[] = &$mform->createElement('button', 'force', get_string('force', 'enrol_attributes'),
                array('onclick' => 'enrol_attributes_force(\''.  addslashes(get_string('confirmforce', 'enrol_attributes')).'\');'));
